    ...
    return (
            <article className="flex flex-col items-center justify-center gap-8 text-gray-700 lg:mb-[-20px] dark:text-gray-300 p-48 xl:mx-44 xl:my-12 md:flex-row">
                ...
                <div className="flex items-center mb-6 text-3xl font-semibold gap-x-3 text-black/80 dark:text-white">
                    ...
                    <p>
                        Para este trabajo se ha seleccionado la <strong>Variante V</strong> del dataset, disponible para su descarga en Kaggle a través de este <a className="text-[#ff7c70] dark:text-[#ff7c70] hover:underline" href="https://www.kaggle.com/datasets/sgpjesus/bank-account-fraud-dataset-neurips-2022/data" target="_blank" rel="noopener noreferrer">enlace</a>.
                    </p>
                </div>
